...
from .views.snippets.generics.snippet_list_api_view import SnippetListAPIView
...
from .views.snippets.generics.snippet_detail_api_view import SnippetDetailAPIView
